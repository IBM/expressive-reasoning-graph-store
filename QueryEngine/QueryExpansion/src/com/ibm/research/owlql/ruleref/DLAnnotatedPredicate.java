...
public class DLAnnotatedPredicate extends Predicate {
  ...
  private static String getName(int arity, OWLObject annotation) {
    ...
    String ret = NAME_PREFIX + "[" + arity + ", " + ren.toString() + "]";
    return ret;
  }
  ...
  public DLAnnotatedPredicate(OWLPropertyExpression propAnnotation, boolean zeroPredicate) {
    super(getName(zeroPredicate ? 0 : 2,
        propAnnotation = (propAnnotation instanceof OWLObjectPropertyExpression
            ? ((OWLObjectPropertyExpression) propAnnotation).getSimplified()
            : propAnnotation)),
        zeroPredicate ? 0 : 2);
  ...
  public int hashCode() {
    ...
    result = prime * result + ((classAnnotation == null) ? 0 : classAnnotation.hashCode());
    result = prime * result + ((propAnnotation == null) ? 0 : propAnnotation.hashCode());
    return result;
  }
