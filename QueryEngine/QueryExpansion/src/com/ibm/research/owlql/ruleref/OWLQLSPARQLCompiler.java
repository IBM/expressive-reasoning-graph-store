...
public class OWLQLSPARQLCompiler extends OWLQLToNonRecursiveDatalogCompiler {
	...
	protected class ExpandBasicGraphPatterns extends ElementTransformCopyBase {
		...
		public Element transform(ElementPathBlock arg0) {
			return transform(OCUtils.toTriples(arg0));
		}
	...
	public static void main(String[] args) throws Exception {
		...
		for (File f: ontFiles) {
			...
			//tboxmodel.read(new FileInputStream(f),"http://swat.cse.lehigh.edu/onto/univ-bench.owl");
		}
		int count = 1;
		OWLQLSPARQLCompiler compiler = new OWLQLSPARQLCompiler(null, null, ontFiles[0].getAbsolutePath());
		for (Query q: queries) {
